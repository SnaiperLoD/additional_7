module.exports = function solveSudoku(matrix) {
    Sudoku = function(matrix) {
        ...
        function sectContent(i, j) {
            ...
            for ( let k=0; k<3; k++ ) {
                for ( let l=0; l<3; l++ ) {
                    if ( 'unsolved' != solved[offset.i+k][offset.j+l][1] ) {
        ...
        function lessSectSuggest(i, j) {
            ...
            for ( let k=0; k<3; k++ ) {
                for ( let l=0; l<3; l++ ) {
                    if ( ((offset.i+k) == i  && (offset.j+l) == j)|| 'unsolved' != solved[offset.i+k][offset.j+l][1] ) {
                        continue;
                    }
        ...
        function isFailed() {
            ...
            for ( let i=0; i<9; i++) {
                for ( let j=0; j<9; j++ ) {
                    if ( 'unsolved' == solved[i][j][1] && !solved[i][j][2].length ) {
                        is_failed = true;
                    }
                }
            }
              ...
              matrix[i].length = 9;
                for ( let j=0; j<9; j++ ) {
                  matrix[i][j] = solved[i][j][0];
                    if ( 'unsolved' == solved[i][j][1] && (solved[i][j][2].length < suggests_cnt || !suggests_cnt) ) {
